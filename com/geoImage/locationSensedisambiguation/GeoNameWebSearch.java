 ...
 */
public class GeoNameWebSearch implements Runnable {

	private int id;
	private int flag;
	private Object[] wrongObjs;

	public GeoNameWebSearch(int id) {
		this.id = id;
	}
	 ...
	 */
	public GeoNameWebSearch(int id, int flag) {
		this.id = id;
		this.flag = flag;
	}
	 ...
	 *            0表示跑正常的，1表示跑错误的;默认是0
	 */
	public GeoNameWebSearch(Object[] wrongObjs, int flag) {
		this.flag = flag;
		this.wrongObjs = wrongObjs;
	}

	public GeoNameWebSearch() {
